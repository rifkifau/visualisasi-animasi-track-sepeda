L.Control.StyledLayerControl = L.Control.Layers.extend({
    ...
    addBaseLayer: function(layer, name, button, group) {
        layer['isBaseLayer'] = true ;
        this._addLayer(layer, name, button, group, false);
        this._update();
        return this;
    },

    addOverlay: function(layer, name, button, group) {
        this._addLayer(layer, name, button, group, true);
        this._update();
        return this;
    },
    ...
    _addLayer: function(layer, name, button, group, overlay) {
        var id = L.Util.stamp(layer);
    ...
    _addItem: function(obj) {
        ...
        button.classList.add('tombol');
        button.innerHTML = obj.button;
